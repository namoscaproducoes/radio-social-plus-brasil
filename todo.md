...
## Fase 21: Extração Real de URL do YouTube
- [x] Instalar biblioteca para extrair URL pública do YouTube (yt-dlp-exec)
- [x] Implementar busca real de vídeos no YouTube com web scraping
- [x] Extrair URL pública do vídeo encontrado
- [x] Armazenar URL no banco de dados com cache
- [x] Usar URL direta no embed do player (sem iframe)
- [x] Testar sincronização com player de rádio
