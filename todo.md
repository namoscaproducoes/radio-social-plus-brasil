...
## Fase 41: Player Persistente Entre Navegacoes
- [x] Mover RadioPlayerV2 para App.tsx (fora do Router)
- [x] Remover RadioPlayerV2 do Home.tsx
- [x] Garantir que player persiste ao navegar para outras paginas
- [x] Manter event listeners vivos entre navegacoes
- [x] Testar navegacao entre home, dashboard e perfil
- [x] Todos os testes passando (38 testes)
